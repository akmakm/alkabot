...
public class Log {
    ...
    private Log(String normalLog, int normalLogNum, int normalLogSize,
        ...
        if (normalLog != null) {
            ...
            normalHandler.setLevel(Level.INFO);
     ...
     */
    public void rabbitError(String payload, Exception e) {
            ...
            timer.scheduleAtFixedRate(new TimerTask() {
                ...
                public void run() {
                    String msg = oneLine(String.format(
                        "read: %d, backed: %d, errors: %d",
                        rabbitRead.getAndSet(0),
                        rabbitBacked.getAndSet(0),
                        rabbitErrors.getAndSet(0)));
                    logger.fine(msg);
                }
